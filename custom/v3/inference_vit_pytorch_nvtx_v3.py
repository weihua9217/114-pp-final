...
from patch_sa_v3 import patch_vit_pytorch_attention_sa_v3
...
def main():
    ...
    model = patch_vit_pytorch_attention_sa_v3(model)
    nvtx.range_pop()
    ...
    print(f"\nAverage time per batch: {total_ms / max_batches:.2f} ms")
